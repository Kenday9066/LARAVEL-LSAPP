...
<div id="cover">        
        <div class="jumbotron jumbotron-fluid">
          <div class="btn-group rightHeader">
            <a href="#"><button class="btn btn-outline-primary">contact.</button></a>
          </div>
          <div class="btn-group leftHeader">        
          <a href="#"><button class="btn btn-outline-primary">return</button></a>
          <a href="#"><button class="btn btn-outline-primary">join</button></a>    
          </div>  
          <div class="container">
...
<div class="p-5 text-center bg-image rounded-3" style="
    background-image: url('https://source.unsplash.com/1600x1050/?computer+screen');
    height: 100vh;
  ...
  <div class="mask" style="background-color: rgba(0, 0, 0, 0.6);">
    <div class="d-flex justify-content-center align-items-center h-100">
      <div class="text-white">
        <h1 class="mb-3">WELCOME TO LSAPP WEBSITE</h1>
        <h4 class="mb-3">Your trusted blogging website</h4>
        <p>This is a laravel application developed from "Laravel from scratch" youtube series tutorials aiming at creating 
                a blogging website thats is functional, fast and user friendly
        </p>
         <a class="btn btn-outline-light btn-lg" href="#" role="button">Login</a> 
        <a class="btn btn-outline-light btn-lg" href="#" role="button">Register</a>
      </div>
    </div>
  </div>
</div>
